	...
	<>
		<div className="dashboard-dock">
			...
			{controlState === "drc_ready" && batteryPercent !== null && (
				<div
					className="dashboard-battery"
					aria-label={`电量 ${batteryPercent}%`}
				>
					<div
		...
		<div
			className={`dashboard-overlay ${isDashboardOpen ? "is-open" : ""}`}
		...
		<div
			className={`media-drawer ${isMediaOpen ? "is-open" : ""}`}
			aria-hidden={!isMediaOpen}
		>
