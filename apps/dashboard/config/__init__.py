...
class BaseConfig:
    ...
    SLAM_MQTT_HOST: str = os.getenv("DJI_SLAM_MQTT_HOST", "127.0.0.1")
    SLAM_MQTT_PORT: int = int(os.getenv("DJI_SLAM_MQTT_PORT", "1883"))
    SLAM_MQTT_USERNAME: str = os.getenv("DJI_SLAM_MQTT_USERNAME", "")
    SLAM_MQTT_PASSWORD: str = os.getenv("DJI_SLAM_MQTT_PASSWORD", "")
