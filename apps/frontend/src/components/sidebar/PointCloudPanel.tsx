...
const PointCloudPanel = ({
	...
	const totalTarget = stats
		...
		: null;
	const progress =
		stats && totalTarget ? Math.min(1, stats.loadedPoints / totalTarget) : null;
	return (
		<section className="dock-card">
			...
			{isLoading && <div className="status-pill">正在加载点云…</div>}
			{isLoading && progress !== null && (
				<div className="progress-block">
					...
					<div className="progress-meta">
						<span>
							{formatNumber(Math.min(stats.loadedPoints, totalTarget))} /{" "}
