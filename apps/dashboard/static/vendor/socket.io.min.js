...
!((e, t) => {
		...
		return (
			(p =
				"undefined" != typeof Reflect && Reflect.get
					...
					: function (e, t, n) {
							var r = ((e, t) => {
								for (; !Object.hasOwn(e, t) && null !== (e = s(e)); );
								return e;
							})(e, t);
							if (r) {
	...
	function y(e, t) {
		...
		if (!n) {
			if (
				...
				return {
					s: i,
					n: () => (r >= e.length ? { done: !0 } : { done: !1, value: e[r++] }),
					e: (e) => {
						throw e;
					},
					f: i,
	...
	function F(e) {
		for (
			...
			n[r - 1] = arguments[r];
		return n.reduce((t, n) => (Object.hasOwn(e, n) && (t[n] = e[n]), t), {});
	}
	var M = I.setTimeout,
		V = I.clearTimeout;
	function H(e, t) {
			...
			return (
				r(s, [
					...
					},
					{
						key: "doWrite",
						value: function (e, t) {
							var r = this.request({ method: "POST", data: e });
							r.on("success", t),
								r.on("error", (e, t) => {
								...
								try {
									if (this.opts.extraHeaders)
										...
										this.opts.extraHeaders))
											Object.hasOwn(this.opts.extraHeaders, o) &&
	...
	function ae() {
		for (var e in se.requests)
			Object.hasOwn(se.requests, e) && se.requests[e].abort();
	}
	var ce =
						...
						value: function () {
							...
							"function" == typeof WebTransport &&
								...
								this.transport.ready.then(() => {
									e.transport.createBidirectionalStream().then((t) => {
										var n = ((e, t) => {
												B || (B = new TextDecoder());
												var n = [],
													r = 0,
										...
										e.query.sid &&
											...
											e.writer.write(o).then(() => e.onOpen());
									});
								}));
						},
					},
	...
	function Ae(t, n) {
		...
		for (var o in t) if (Object.hasOwn(t, o) && Ae(t[o])) return !0;
		return !1;
	}
	function Oe(e) {
		var t = [],
	...
	function Te(t, n) {
		...
		if ("object" === e(t) && !(t instanceof Date)) {
			var s = {};
			for (var a in t) Object.hasOwn(t, a) && (s[a] = Te(t[a], n));
			return s;
		}
		return t;
	}
	...
	function Ce(t, n) {
		...
		if (Array.isArray(t)) for (var r = 0; r < t.length; r++) t[r] = Ce(t[r], n);
			...
			for (var i in t) Object.hasOwn(t, i) && (t[i] = Ce(t[i], n));
		return t;
	}
	var Be,
		Se = [
